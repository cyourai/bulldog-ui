    ...
    <div class="content">
      <div class="content-spe">
        ...
        <div class="content-spe-element">
          <div class="leftPart">
            <el-input placeholder="输入关键字进行过滤" v-model="filterText" class="searchInput"></el-input>
            <el-tree
                    class="filter-tree"
                    :data="data"
                    :props="defaultProps"
          ...
          <div class="rightPart">
            <el-form label-position="right" label-width="150px" :model="menuEditForm" ref="menuEditForm">
              <el-form-item label="菜单路由" prop="path">
                <el-input v-model="menuEditForm.path" :disabled="formDisable"></el-input>
              </el-form-item>
              <el-form-item label="页面组件" prop="component">
                <el-input v-model="menuEditForm.component" :disabled="formDisable"></el-input>
              </el-form-item>
              <el-form-item label="重定向路径" v-if="isRoot" prop="redirect">
                <el-input v-model="menuEditForm.redirect" :disabled="formDisable"></el-input>
              </el-form-item>
              <el-form-item label="菜单名称(中文)" prop="label">
                <el-input v-model="menuEditForm.label" :disabled="formDisable"></el-input>
              </el-form-item>
              <el-form-item label="唯一标识(英文)" v-if="isSub" prop="name">
                <el-input v-model="menuEditForm.name"></el-input>
              </el-form-item>
              <el-form-item label="页面标题" prop="meta.title">
                <el-input v-model="menuEditForm.meta.title" :disabled="formDisable"></el-input>
              </el-form-item>
              <el-form-item label="是否总是显示" v-if="isRoot" prop="alwaysShow">
                <el-switch v-model="menuEditForm.alwaysShow"></el-switch>
              </el-form-item>
              <el-form-item label="访问权限" v-if="isRoot" prop="meta.roles">
                <el-input v-model="menuEditForm.meta.roles" @focus="showTransferHandler"></el-input>
              </el-form-item>
              <el-form-item label="是否隐藏" v-if="isSub" prop="hidden">
