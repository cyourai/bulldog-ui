    ...
    <el-form class="form-container"
      ...
      <div class="createPost-main-container">
        <el-row>
          <el-col :span="21">
            <el-form-item style="margin-bottom: 40px;"
              ...
              <span v-show="postForm.title.length>=26"
                    class='title-prompt'>app可能会显示不全</span>
            </el-form-item>
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item label-width="45px"
                    ...
                    <multiselect v-model="postForm.author"
        ...
        <div class="editor-container">
          <tinymce-gallery id="content"
                          v-model="postForm.content"
                          :type='"PhotoGallery"'
                          @keyup="this.tinymceHandler"
          ></tinymce-gallery>
          父组件接收:{{this.postForm.content}}
        </div>
...
<script>
  ...
  export default {
    name: 'articleDetail',
    components: { TinymceGallery, MDinput, Upload, Multiselect, Sticky },
    props: {
      isEdit: {
        type: Boolean,
        default: false
