    ...
    <div>
        <transition :name="mergedOption.transition">
            <div
                    ...
                    v-show="showing"
            >
                <i class="toast-icon icon-ic_warning"></i><span class="et-content" v-html="mergedOption.message"></span>
                <a class="et-close" v-if="mergedOption.closeable" @click="close()">&times;</a>
            </div>
        </transition>
    </div>
</template>
